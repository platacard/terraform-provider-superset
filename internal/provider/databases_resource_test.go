...
func TestAccDatabaseResource_SupersetOverridesAllowFlags(t *testing.T) {
	// Activate httpmock
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	// Superset may override allow_* flags. Simulate API returning the opposite of the plan.
	httpmock.RegisterResponder("POST", "http://superset-host/api/v1/database/",
		httpmock.NewStringResponder(201, `{
			"id": 209,
			"result": {
				...
				"cache_timeout": null,
				"configuration_method": "sqlalchemy_form",
				"database_name": "DWH_database_connection_override",
				"driver": "psycopg2",
				"expose_in_sqllab": true,
				"extra": "{\"client_encoding\": \"utf8\"}",
				"parameters": {
...
resource "superset_database" "test" {
  connection_name = "DWH_database_connection_override"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("superset_database.test", "connection_name", "DWH_database_connection_override"),
					resource.TestCheckResourceAttr("superset_database.test", "allow_ctas", "false"),
					resource.TestCheckResourceAttr("superset_database.test", "allow_cvas", "false"),
					resource.TestCheckResourceAttr("superset_database.test", "allow_dml", "false"),
					resource.TestCheckResourceAttr("superset_database.test", "allow_run_async", "true"),
